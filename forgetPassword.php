          ...
          <div class="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg">
            ...
            <?php } ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" class="form-control p_input" name="confirmpass">
                  </div>
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn btn-primary btn-block enter-btn" name="confirm">Confirm</button>
                  </div>
                  <div class="d-flex">
                    <button class="btn btn-facebook me-2 col">
                    
                      <i class="mdi mdi-facebook"></i> <a href="http://www.facebook.com/YOURUSERNAMEHERE">Facebook</a> </button>
