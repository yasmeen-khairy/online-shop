...
<section id="hero" style="background-image:url('img/banner-bg.png') ;">

        <h4 style="color: white;">Trade-in-offer</h4>
        <h2 style="color: white;">Super value deals</h2>
        <h1>On all products</h1>
        <p style="color: white;">Save more woth coupons & up to 70% off!</p>
        ...
        <div class="pro-container">
            <div class="pro">
                ...
                <div class="des">
                    ...
                    <h4>78</h4>
                    <a href="shopping.php" class="cart"><i class="fas fa-shopping-cart"></i></a>
                </div>
            </div>
